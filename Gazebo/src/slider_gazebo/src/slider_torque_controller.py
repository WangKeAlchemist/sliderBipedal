...
def slider_joint_torques_publisher():
	...
	pub1 = rospy.Publisher('/slider_gazebo/left_base_joint_torque_controller/command', Float64, queue_size=50)
	pub2 = rospy.Publisher('/slider_gazebo/base_to_left_leg_torque_controller/command', Float64, queue_size=50)
	pub3 = rospy.Publisher('/slider_gazebo/right_base_joint_torque_controller/command', Float64, queue_size=50)
	pub4 = rospy.Publisher('/slider_gazebo/base_to_right_leg_torque_controller/command', Float64, queue_size=50)
